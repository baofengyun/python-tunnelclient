...
def get_vpnserver_attrs(client_manager, parsed_args):
    attr_map = {
        'name': ('name', str),
        ...
        'vpnserver': (
            'vpnserver_id',
            'vpnservers',
            client_manager.vpn_server.vpn_server_list
        ),
        ...
        'flavor': (
            'flavor_id',
            'flavors',
            client_manager.vpn_server.flavor_list
        ),
...
def get_listener_attrs(client_manager, parsed_args):
    attr_map = {
        ...
        'listener': (
            'listener_id',
            'listeners',
            client_manager.vpn_server.listener_list
        ),
        'vpnserver': (
            'vpnserver_id',
            'vpnservers',
        ...
        'default_pool': (
            'default_pool_id',
            'pools',
            client_manager.vpn_server.pool_list
        ),
        'project': (
            'project_id',
            'project',
...
def get_user_attrs(client_manager, parsed_args):
    attr_map = {
        'name': ('name', str),
        'description': ('description', str),
        ...
        'user': (
            'user_id',
            'users',
            client_manager.vpn_server.user_list
        ),
        'vpnserver': (
            'vpnserver_id',
            'vpnservers',
...
def get_secgroup_attrs(client_manager, parsed_args):
    attr_map = {
        'name': ('name', str),
        'description': ('description', str),
        ...
        'secgroup': (
            'secgroup_id',
            'secgroups',
            client_manager.vpn_server.secgroup_list
        ),
        'vpnserver': (
            'vpnserver_id',
            'vpnservers',
...
def get_resource_attrs(client_manager, parsed_args):
    attr_map = {
        'name': ('name', str),
        ...
        'resource': (
            'resource_id',
            'resources',
            client_manager.vpn_server.resource_list
        ),
        'vpnserver': (
            'vpnserver_id',
            'vpnservers',
...
def get_member_attrs(client_manager, parsed_args):
    attr_map = {
        ...
        'member': (
            ...
            'members',
            'pool',
            client_manager.vpn_server.member_list
        ),
...
def get_l7policy_attrs(client_manager, parsed_args):
    attr_map = {
        ...
        'l7policy': (
            'l7policy_id',
            'l7policies',
            client_manager.vpn_server.l7policy_list
        ),
        'redirect_pool': (
            'redirect_pool_id',
            'pools',
...
def get_l7rule_attrs(client_manager, parsed_args):
    attr_map = {
        ...
        'l7rule': (
            ...
            client_manager.vpn_server.l7rule_list
        ),
        'l7policy': (
            'l7policy_id',
            'l7policies',
...
def get_health_monitor_attrs(client_manager, parsed_args):
    attr_map = {
        'health_monitor': (
            'health_monitor_id',
            'healthmonitors',
            client_manager.vpn_server.health_monitor_list
        ),
        'project': (
            'project_id',
            'project',
...
def get_amphora_attrs(client_manager, parsed_args):
    attr_map = {
        'amphora_id': (
            'amphora_id',
            'amphorae',
            client_manager.vpn_server.amphora_list,
        ),
        'vpnserver': (
            'vpnserver_id',
            'vpnservers',
...
def get_flavor_attrs(client_manager, parsed_args):
    attr_map = {
        ...
        'flavorprofile': (
            'flavor_profile_id',
            'flavorprofiles',
            client_manager.vpn_server.flavorprofile_list,
        ),
...
def get_availabilityzone_attrs(client_manager, parsed_args):
    attr_map = {
        ...
        'availabilityzone': (
            ...
            'availability_zones',
            client_manager.vpn_server.availabilityzone_list,
        ),
        'availabilityzoneprofile': (
            'availability_zone_profile_id',
            'availability_zone_profiles',
            client_manager.vpn_server.availabilityzoneprofile_list,
        ),
        'enable': ('enabled', lambda x: True),
        'disable': ('enabled', lambda x: False),
        'description': ('description', str),
...
def wait_for_active(status_f, res_id):
    ...
    if not success:
        raise exceptions.TunnelClientException(
            code="n/a",
...
def wait_for_delete(status_f, res_id,
    ...
    except exceptions.TunnelClientException as e:
        if e.code != 404:
            raise
